    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <ScrollView contentContainerStyle={styles.container}>
          ...
          {/*
            Apple and Google sign-in are intentionally absent until they are real.
            Turning them on needs a provider configured in the Supabase dashboard
            plus expo-apple-authentication / expo-auth-session wired to
            supabase.auth.signInWithIdToken — a button that fakes a session is
