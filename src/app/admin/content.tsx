      ...
      {summary.isLoading ? (
        ...
        <View style={styles.errorBox}>
          <Text style={styles.errorText}>
            {summary.error?.message || "Could not load menu health."}
          </Text>
        </View>
      ) : (
        <>
            ...
            <Card style={styles.card}>
              <View style={styles.syncRow}>
                <View style={{ flex: 1 }}>
                  ...
                  >
                    {s?.last_sync
                      ? fullDate(s.last_sync)
                      : "The scan pipeline has no menu to match against."}
                  </Text>
                </View>
                <SeverityChip
                  severity={syncSev}
          ...
          <View style={styles.tileGrid}>
            ...
            <StatTile
              ...
              hint={
                s?.earliest_date
                  ? `since ${fullDate(s.earliest_date)}`
                  : undefined
              }
              style={styles.tile}
            />
          ...
          {calorieSev !== "good" ? (
            <Text style={styles.warningNote}>
              A dish with no calorie figure can be picked on the menu screen but
              the scan matcher cannot price it — every point here is a plate a
              student logs as a low-confidence guess.
            </Text>
          ) : null}
          ...
          <View style={styles.section}>
            ...
            {engagement.isLoading ? (
              ...
              <>
                ...
                <Text style={[styles.subEyebrow, { marginTop: 20 }]}>
                  TOP STATIONS
                </Text>
                <Card style={styles.card}>
