...
export default function MenuScreen() {
    ...
    const periodItems = menuItems.filter((item) => {
      ...
      if (mealPeriod === "coop") {
        return (
          ...
          item.station_name.toLowerCase().includes("grill")
        );
      }
  ...
  const handleQuickLog = async (item: ParsedMenuItem) => {
    ...
    try {
      ...
      setLogError(
        `Could not log "${item.dish_name}": ${e?.message ?? "unknown error"}`,
      );
    } finally {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.filterRow}>
          ...
          <Chip
            ...
            onPress={() =>
              setSelectedTag(selectedTag === "Vegan" ? null : "Vegan")
            }
          />
          <Chip
            label="Vegetarian"
          ...
          <Chip
            ...
            onPress={() =>
              setSelectedTag(
                selectedTag === "High Protein" ? null : "High Protein",
              )
            }
          />
        </View>
        ...
        <View style={styles.disclaimerBox}>
          ...
          <Text style={styles.disclaimerText}>
            Cross-contact risk exists in commercial kitchens. Check Nutrislice
            for complete allergen tables.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
